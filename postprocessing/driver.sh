pyscript="postp_lhc_pxbmean.py"
outdir="/glade/work/linnia/CLM6-PPE/ctsm53065_lhc/postp/tmp/"
outfile="ctsm53065_lhc_pxbmean_1985-2014.nc"
author="lh3194@columbia.edu" #no whitespace!!
