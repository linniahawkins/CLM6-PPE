...
# datm files
cd '/glade/work/linnia/PPEn14trans/cime/src/components/data_comps_mct/datm/cime_config/'
# change only GSWP3v1
#sed -i 's:"CLMGSWP3v1">$DIN_LOC_ROOT_CLMFORC/atm_forcing.datm7.GSWP3.0.5d.v1.c170516:"CLMGSWP3v1">$DIN_LOC_ROOT_CLMFORC/atm_forcing.datm7.GSWP3.0.5d.v1.c210222_400:g' namelist_definition_datm.xml
#sed -i 's:"CLMGSWP3v1">domain.lnd.360x720_gswp3.0v1.c170606.nc:"CLMGSWP3v1">domain.lnd.360x720_gswp3.0v1.c170606v4.dense400.nc:g' namelist_definition_datm.xml

# Changing both GSWP3 and GSWP3v1:
sed -i 's:atm_forcing.datm7.GSWP3.0.5d.v1.c170516:atm_forcing.datm7.GSWP3.0.5d.v1.c210222_400:g' namelist_definition_datm.xml
sed -i 's:domain.lnd.360x720_gswp3.0v1.c170606.nc:domain.lnd.360x720_gswp3.0v1.c170606v4.dense400.nc:g' namelist_definition_datm.xml
